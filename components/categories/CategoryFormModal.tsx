      ...
      <div className="p-5 space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full h-9 px-3 text-sm text-black border border-black/[0.06] rounded-lg bg-white/50 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent placeholder:text-neutral-400"
            onKeyDown={(e) => {
              if (e.key === 'Enter') {
                e.preventDefault()
                handleSave()
